  ...
  return (
    <section className="space-y-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="grid w-full gap-2 sm:grid-cols-2 xl:w-auto xl:grid-cols-[240px_auto_auto_auto_auto]">
          <DateRangeFilter
            startDate={startDate}
            endDate={endDate}
            onChange={(start, end) => {
      ...
      <Card className="rounded-lg border-white/80 bg-white/80 shadow-sm">
        <CardContent className="p-0">
          <div className="flex flex-col gap-3 border-b border-rose-50 px-4 py-4 sm:px-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto sm:flex-wrap sm:items-center">
              <div className="col-span-2 flex min-h-10 items-center justify-center gap-2 rounded-lg border border-rose-100 bg-white px-3 text-sm text-stone-600 sm:col-span-1 sm:justify-start lg:min-h-8">
                <Checkbox
                  ...
                  className="size-10 rounded-lg border-rose-200 bg-white lg:size-4 lg:rounded-[4px]"
                />
                本页全选
              </div>
              {selectedCount > 0 ? (
              ...
              <Button
                variant="outline"
                className="h-10 min-h-10 rounded-lg border-rose-100 bg-white px-3 text-stone-600 lg:h-8 lg:min-h-8"
          ...
          {!isLoading && total > 0 ? (
            <div className="flex flex-col gap-2 border-t border-rose-50 px-4 py-3 text-sm text-stone-500 sm:flex-row sm:items-center sm:justify-end">
              <span className="text-center sm:text-left">第 {safePage} / {pageCount} 页，共 {total} 张</span>
